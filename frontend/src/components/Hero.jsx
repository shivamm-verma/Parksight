...
export default function Hero() {
  ...
  return (
    <section className="relative bg-white pt-40 pb-28 px-6 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <h1 className="font-impact text-balance text-[48px] sm:text-[72px] lg:text-[92px] leading-[0.95] text-[var(--ink)]">
          SEE WHAT'S BLOCKING THE ROAD
        </h1>

        <p className="mt-7 text-[19px] sm:text-[22px] text-[var(--ink-soft)] max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="mt-10 flex items-center justify-center gap-4">
          <button
            ...
            className="bg-[var(--red)] text-white text-[16px] font-medium px-7 py-3.5 rounded-full hover:bg-[var(--red-dark)] transition-colors shadow-sm flex items-center gap-2"
          >
            See working <ArrowRight className="w-4 h-4" />
          </button>
          <a
            href="#stats"
            className="text-[16px] font-medium text-[var(--ink)] px-7 py-3.5 rounded-full border border-black/10 hover:bg-black/5 transition-colors flex items-center gap-2"
          >
      ...
      <div className="max-w-5xl mx-auto mt-20">
        <div className="rounded-[28px] bg-[var(--grey-bg)] aspect-[16/8] flex items-center justify-center relative overflow-hidden">
          ...
          <div className="absolute bottom-6 left-6 bg-white rounded-2xl shadow-lg px-5 py-3">
            <p className="text-[11px] uppercase tracking-wide text-[var(--ink-soft)] font-semibold">Top hotspot</p>
            <p className="text-[20px] font-semibold text-[var(--ink)]">Congestion impact: High</p>
          </div>
        </div>
      </div>
    </section>
